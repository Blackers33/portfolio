	...
	return (
		<>
			...
			<div className='bg-background mb-20'>
				<div className='space-x-30 flex justify-center mb-20'>
					<div className='relative inline-flex  group'>
						...
						<a
							...
							role='button'
						>
							<FaSoundcloud className='-ml-3 mr-3 group-hover:text-orange-400' />
							Soundcloud
						</a>
					</div>
					<div className='relative inline-flex  group'>
						...
						<a
							...
							role='button'
						>
							<FaYoutube className='-ml-3 mr-3 group-hover:text-red-500' />
							Youtube
						</a>
					</div>
				</div>
