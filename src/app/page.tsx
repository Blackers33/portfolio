	...
	return (
		<>
			...
			<div className='bg-background px-8 lg:px-80 space-y-4 text-lg leading-relaxed  '>
				<p className='mb-8'>
					Après une carrière dans les secteurs des télécommunications,
					du réseau et de l’audiovisuel, j’ai pris une décision importante : me
				...
				<p className='mb-8'>
					...
					– qu’il s’agisse de résoudre des problèmes complexes en réseau ou de
					gérer des projets audiovisuels – se révèlent précieuses dans mon
					travail de développeur. Je mets à profit non seulement mes
				...
				<p className='mb-8'>
					...
					informatique, témoigne de mon engagement envers l’apprentissage
					continu et ma capacité à relever de nouveaux défis. Je suis
					enthousiaste à l’idée d’apporter ce mélange unique d’expérience et de
					passion à des projets innovants, en créant des solutions qui unissent
